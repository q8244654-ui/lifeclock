              ...
              >
                ...
                >
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-4 py-3 rounded-lg text-[#FAFAFA] font-semibold relative overflow-hidden flex items-center justify-center gap-2"
                    style={{
                      background: `linear-gradient(135deg, ${book.color}80 0%, ${book.color}60 100%)`,
                      fontFamily: 'var(--font-body)',
